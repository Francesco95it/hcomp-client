        ...
        return (
            <div>
                ...
                {this.state.runs.map((run)=>{
                    ...
                    return (
                        <Segment.Group key={run.index}  piled style={{marginBottom:'1em'}}>
                                        ...
                                        <Grid.Column stretched width={6}>
                                            <Form>
                                                ...
                                                <Form.Field>
                                                    ...
                                                    />
                                                    {run.type.type === 8 ? <span>Maximum selectable emotions: {' '}<Dropdown scrolling inline options={dropOptions} defaultValue={run.max_emotions} onChange={(e, opt)=>this.changeMaxEmotions(run.index, opt.value)} /></span> : null}
                                                </Form.Field>
                                            </Form>
                                        </Grid.Column>
                                    </Grid>
